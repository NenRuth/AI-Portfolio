...
#fav_soups = ['oha', 'nsala', 'veggies', 'okro']
#for fav_soup in fav_soups:
 	#print(fav_soup.title())

# • Modify your for loop to print a sentence using the name of the pizza
# instead of printing just the name of the pizza. For each pizza you should
# have one line of output containing a simple statement like I like pepperoni
# pizza.
	# print("Have you tried goat meat with " + fav_soup + " soup?")
...
#print("oh!, I really want to have one these right now!")
...
# for cat in cats:
# 	print(cat.upper() + ', these are wild cats!')
# 	print("I can't have, " + cat + "as a pet" + "\n")
# print("Once again, keep your pet, " + cat)
